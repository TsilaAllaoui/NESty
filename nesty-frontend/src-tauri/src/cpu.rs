...
impl Serialize for Cpu {
    ...
    where
        S: Serializer,
    {
        let mut state = serializer.serialize_struct("Cpu", 9)?;
        state.serialize_field("register_a", &self.register_a)?;
        state.serialize_field("register_x", &self.register_x)?;
        state.serialize_field("register_y", &self.register_y)?;
        state.serialize_field("register_s", &self.register_s)?;
